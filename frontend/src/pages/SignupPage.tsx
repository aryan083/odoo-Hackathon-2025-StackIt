...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-neutral-950 py-8 px-2">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700 p-4 sm:p-7">
            ...
            <div className="grid gap-y-4">
              ...
              <div>
                <div className="flex flex-wrap justify-between items-center gap-2">
                  ...
                  <a className="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="/recover-account">Forgot password?</a>
                </div>
                <div className="relative">
                  <input
                    type="password"
              ...
              <div className="flex items-center">
                <div className="flex">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="shrink-0 mt-0.5 border border-black rounded-sm text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                    checked={rememberMe}
